...
from libs.Unet_base_manual import UNet
...
if __name__ == '__main__':
    ...
    if args.profile == 'True':
        with profiler.profile(
            ...
            on_trace_ready=profiler.tensorboard_trace_handler(f'./log_spin_base_{args.w}'),
            record_shapes=True,
            profile_memory=True,
            with_stack=True
        ) as p:
    ...
    if args.profile == 'True':
        with profiler.profile(
            ...
            on_trace_ready=profiler.tensorboard_trace_handler(f'./log_hd_base_{args.w}'),
            record_shapes=True,
            profile_memory=True,
            with_stack=True
        ) as p:
